...
import { TopPlacesData, TopCollegesData, CollegeArticleData, AcadCounsellor, CollegeChooseData, FCCard, CollegeRankingData, ApplicationDatesData, ScholarshipData, ExamsData, HongkongFAQsData } from "./Data";

const HongkongPage = () => {

  const countryName = "Hongkong"
